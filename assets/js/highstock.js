...
(function(Q, L) {
    ...
    var L = function() {
        ...
        return a.Highcharts ? a.Highcharts.error(16, !0) : {
            ...
            doc: G,
            hasBidiBug: q,
            hasTouch: G && void 0 !== G.documentElement.ontouchstart,
            isMS: v,
    ...
    (function(a) {
        ...
        a.addEvent = function(v, k, q) {
            ...
            v.hcEvents &&
                !Object.prototype.hasOwnProperty.call(v, "hcEvents") && (t = {}, a.objectEach(v.hcEvents, function(a, m) {
                    t[m] = a.slice(0)
                }), v.hcEvents = t);
        ...
        a.fireEvent = function(v, k, q, w) {
            ...
            if (E.createEvent && (v.dispatchEvent || v.fireEvent)) t = E.createEvent("Events"), t.initEvent(k, !0, !0), a.extend(t, q), v.dispatchEvent ? v.dispatchEvent(t) : v.fireEvent(k, t);
                ...
                for (t = t[k] || [], u = t.length, q.target || a.extend(q, {
    ...
    (function(a) {
        ...
        c(G.prototype, {
            ...
            colorGradient: function(h, d, y) {
                ...
                c && (l = h[c], r = K.gradients, S = h.stops, D = y.radialReference, I(l) && (h[c] = l = {
                    x1: l[0],
                    y1: l[1],
                    x2: l[2],
                    y2: l[3],
                    gradientUnits: "userSpaceOnUse"
                }), "radialGradient" === c && D && !z(l.gradientUnits) && (n = l, l = A(l, K.getRadialAttr(D, n), {
                    gradientUnits: "userSpaceOnUse"
                })), p(l, function(a, h) {
                    "id" !== h && g.push(h, a)
                }), p(S, function(a) {
                ...
                if (!d) {
                    if (p.namespaceURI === this.SVG_NS || y.forExport) {
                        try {
                            ...
                            }) && A("none"), d = p.getBBox ? c({}, p.getBBox()) : {
                                width: p.offsetWidth,
            ...
            shadow: function(a, h, d) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    for (b = 1; b <= l; b++) c = p.cloneNode(0), e = 2 * l + 1 - 2 * b, k(c, {
                        isShadow: "true",
                        ...
                        fill: "none"
                    }), d && (k(c, "height", Math.max(k(c, "height") -
        ...
        c(E.prototype, {
                        ...
                        -1 !== c.indexOf(" ") ? (A = /<.*class="([^"]+)".*>/, K = /<.*style="([^"]+)".*>/, C = /<.*href="([^"]+)".*>/, x && x.appendChild(d), c = l ? c.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [c], c = r(c, function(a) {
                            ...
                            e(p, function(h) {
                                if ("" !== h || 1 === p.length) {
                                    ...
                                    C.test(h) && !b && (k(n, "onclick", 'location.href\x3d"' + h.match(C)[1] + '"'), k(n, "class", "highcharts-anchor"), t(n, {
                                        cursor: "pointer"
                                    }));
                                    console.log(A.test(h) &&(r = h.match(A)[1], k(n, "class", r)));
                                    console.log(K.test(h) && (D = h.match(K)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), k(n, "style", D)));
                                    console.log(C.test(h) &&!b && (k(n, "onclick", 'location.href\x3d"' + h.match(C)[1] + '"'), k(n, "class", "highcharts-anchor"), t(n, {
                                        cursor: "pointer"
                                    })));
                                    ...
                                    if (" " !== h){// && h.trim() !='24. Dec') {
                                        ...
                                        if (m) {
                                            ...
                                            var x = [],
                                                N, P = z(n),
                                                S = a.rotation;
                                            for (F && (g = y.applyEllipsis(a, n, h, m)); !F && r && (e.length || x.length);) a.rotation = 0, N = y.getSpanWidth(a, n), h = N > m, void 0 === g && (g = h), h && 1 !== e.length ? (n.removeChild(n.firstChild), x.unshift(e.pop())) : (e = x, x = [], e.length && !I && (n = f.createElementNS(O, "tspan"), k(n, {
                                                dy: P,
                                                x: B
                                            }), D && k(n, "style", D), d.appendChild(n)), N > m && (m = N)), e.length && n.appendChild(f.createTextNode(e.join(" ").replace(/- /g,
                                                "-")));
                                            a.rotation = S
                                        }
                                        l++
            ...
            symbol: function(a, h, d, y, b, p) {
                var l = this,
                    ...
                    x, B;
                C ? (n = this.path(g), n.attr("fill", "none"), c(n, {
                    symbolName: M,
                    x: h,
                    y: d,
                    width: y,
                    height: b
                }), p && c(n, p)) : r && (x = a.match(A)[1], n = this.image(x), n.imgwidth = D(N[x] && N[x].width, p && p.width), n.imgheight =
                    D(N[x] && N[x].height, p && p.height), B = function() {
                        ...
                        x: h,
                        y: d
                    }), n.isImg = !0, z(n.imgwidth) && z(n.imgheight) ? B() : (n.attr({
                        width: 0,
                        height: 0
                    }), u("img", {
                        onload: function() {
            ...
            symbols: {
                circle: function(a, h, d, y) {
                    return this.arc(a + d / 2, h + y / 2, d / 2, y / 2, {
                        start: 0,
                        end: 2 * Math.PI,
                        open: !1
                    })
            ...
            text: function(a, h, d, y) {
                ...
                y || (a.xSetter = function(a, h, d) {
                    var y = d.getElementsByTagName("tspan"),
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        ...
                        d !== this.cTT && (n = a.fontMetrics(b.style.fontSize).b, v(B) && this.setSpanRotation(B, F, n), H(b, {
                            width: "",
                            whiteSpace: A || "nowrap"
                        }), b.offsetWidth > t && /[ \-]/.test(b.textContent || b.innerText) && H(b, {
                            width: t + "px",
                            display: "block",
                            whiteSpace: A || "normal"
                        }), this.getSpanCorrection(b.offsetWidth, n, F, B, x));
                        H(b, {
        ...
        a.Tick.prototype = {
            addLabel: function() {
                ...
                u = a.labelFormatter.call({
                    ...
                    value: a.isLog ? G(a.lin2log(g)) : g,
                    pos: f
                });
                E(m) ? m && m.attr({
                    text: u
                }) : (this.labelLength = (this.label = m = E(u) && e.enabled ? z.renderer.text(u, 0, 0, e.useHTML).css(k(e.style)).add(a.labelGroup) : null) && m.getBBox().width, this.rotation = 0)
            },
            ...
            getPosition: function(a, k, q, m) {
                var g = this.axis,
                    f = g.chart,
                    e = m && f.oldChartHeight || f.chartHeight;
                return {
                    x: a ? g.translate(k + q, null, null, m) + g.transB : g.left + g.offset + (g.opposite ? (m && f.oldChartWidth || f.chartWidth) - g.right - g.left : 0),
                    y: a ? e - g.bottom + g.offset - (g.opposite ? g.height : 0) : e - g.translate(k + q, null, null, m) - g.transB
                }
            },
            ...
            renderMark: function(a, k, z) {
                var m = this.axis,
                    ...
                    C = a.x;
                a = a.y;
                var t = q(g[c + "Width"], !e && m.isXAxis ? 1 : 0),
                    g = g[c + "Color"];
                b && (m.opposite && (b[0] = -b[0]), l && (this.mark = r = f.path().addClass("highcharts-" + (e ? e + "-" : "") + "tick").add(m.axisGroup), r.attr({
                    stroke: g,
                    "stroke-width": t
                })), r[l ? "attr" : "animate"]({
                    d: this.getMarkPath(C, a, b[0], r.strokeWidth() * z, m.horiz, f),
                    opacity: k
                }))
            },
        ...
        a.extend(D.prototype, {
            ...
            getMinorTickPositions: function() {
                var a = this,
                    ...
                    l = e - n;
                if (l && l / c < a.len / 3)
                    if (a.isLog) m(this.paddedTicks, function(h, d, y) {
            ...
            adjustForMinRange: function() {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog && (t(a.min) || t(a.max) ? this.minRange = null : (m(this.series, function(a) {
                        A = a.xData;
                        for (n = r = a.xIncrement ? 1 : A.length - 1; 0 < n; n--)
            ...
            zoom: function(a, d) {
                ...
                if (a !== this.min || d !== this.max) this.allowZoomOutside || (t(h) && (a < p && (a = p), a > c && (a = c)), t(b) && (d < p && (d = p), d > c && (d = c))), this.displayBtn = void 0 !== a || void 0 !== d, this.setExtremes(a, d, !1, void 0, {
                    trigger: "zoom"
                });
                return !0
            },
            ...
            tickSize: function(a) {
                var d = this.options,
                    h = d[a + "Length"],
                    b = B(d[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            renderUnsquish: function() {
                ...
                if (this.autoRotation) g > l && g > r.h ? A.rotation = this.labelRotation : this.labelRotation = 0;
                    ...
                    for (D.textOverflow = "clip", C = b.length; !e && C--;)
                        if (B = b[C], l = c[B].label) l.styles && "ellipsis" === l.styles.textOverflow ? l.css({
                            textOverflow: "clip"
                        }) : c[B].labelLength > n && l.css({
                            width: n + "px"
                        }), l.getBBox().height > this.len / b.length - (r.h - r.f) && (l.specCss = {
                            textOverflow: "ellipsis"
                        });
                A.rotation && (D = {
                    width: (g > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px"
                }, f || (D.textOverflow = "ellipsis"));
            ...
            addTitle: function(a) {
                var d = this.chart.renderer,
                    ...
                    p;
                this.axisTitle || ((p = c.textAlign) || (p = (h ? {
                    low: "left",
                    middle: "center",
                    high: "right"
                } : {
            ...
            getOffset: function() {
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (u || "")).add(z), a.axisGroup = b.g("axis").attr({
                    zIndex: c.zIndex || 2
                }).addClass("highcharts-" +
                    this.coll.toLowerCase() + " " + (u || "")).add(z), a.labelGroup = b.g("axis-labels").attr({
                    zIndex: k.zIndex || 7
                }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (u || "")).add(z));
                f || a.isLinked ? (m(p, function(d, h) {
                        a.generateTick(d, h)
                    }), a.renderUnsquish(), a.reserveSpaceDefault = 0 === A || 2 === A || {
                        1: "left",
                        3: "right"
                    }[A] === a.labelAlign, B(k.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && m(p, function(a) {
            ...
            getTitlePosition: function() {
                ...
                return {
                    x: a ? c + A : d + (n ? this.width : 0) + l + A,
                    y: a ? d + r - (n ? this.height : 0) + l : c + r
                }
            },
            ...
            renderTick: function(a, d) {
                var b = this.isLinked,
                    h = this.ticks,
                    c = this.chart.hasRendered && C(this.oldMin);
            ...
            render: function() {
                ...
                if (b.hasData() || r) b.minorTickInterval && !b.categories && m(b.getMinorTickPositions(), function(a) {
                    ...
                    0 === h % 2 && d < b.max && z <= b.max + (c.polar ? -q : q) && (B[d] || (B[d] = new a.PlotLineOrBand(b)), u = d + q, B[d].options = {
                        from: l ? A(u) : u,
                        to: l ? A(z) : z,
                        color: k
            ...
            drawCrosshair: function(a, d) {
                ...
                this.crosshair && !1 !== (t(d) || !c) ? (c ? t(d) && (p = this.isXAxis ? d.plotX : this.len - d.plotY) : p = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), t(p) && (b = this.getPlotLinePath(d && (this.isXAxis ? d.x : B(d.stackY, d.y)), null, null, null, p) || null), t(b) ? (d = this.categories && !this.isRadial, e || (this.cross =
                    e = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (d ? "category " : "thin ") + h.className).attr({
                        zIndex: B(h.zIndex, 2)
                    }).add(), e.attr({
                        stroke: h.color || (d ? k("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                var k = this,
                    ...
                    A = f.events,
                    n = {
                        "class": "highcharts-plot-" + (C ? "band " : "line ") + (f.className || "")
                    },
                    d = {},
                    p = m.chart.renderer,
                    D = C ? "bands" : "lines",
                ...
                }, f.dashStyle && (n.dashstyle = f.dashStyle)) : C && (B && (n.fill = B), f.borderWidth && (n.stroke = f.borderColor, n["stroke-width"] = f.borderWidth));
                d.zIndex = J;
                D += "-" + J;
                ...
                F && n && n.length ? (x.attr({
                    d: n
                }), A && a.objectEach(A, function(a, d) {
                    x.on(d, function(a) {
                        A[d].apply(k, [a])
                    })
                })) : x && (n ? (x.show(), x.animate({
                    d: n
                })) : (x.hide(), c && (k.label = c = c.destroy())));
                e && v(e.text) && n && n.length && 0 < m.width && 0 < m.height && !n.flat ? (e = t({
                    align: g && C && "center",
                    x: g ? !C && 4 : 10,
                    verticalAlign: !g && C && "middle",
                    y: g ? C ? 16 : 10 : C ? 6 : -4,
                    rotation: g && !C && 90
                }, e), this.renderLabel(e, n, C, J)) : c && c.hide();
                return k
            },
        ...
        a.Tooltip.prototype = {
            ...
            move: function(a, f, e, c) {
                ...
                H(r, {
                    x: l ? (2 * r.x + a) / 3 : a,
                    y: l ? (r.y + f) / 2 : f,
                    anchorX: g ? void 0 : l ? (2 * r.anchorX + e) / 3 : e,
                    anchorY: g ? void 0 : l ? (r.anchorY + c) / 2 : c
                });
                b.getLabel().attr(r);
            ...
            refresh: function(a, f) {
                ...
                c.enabled && (clearTimeout(this.hideTimer), this.followPointer = u(r)[0].series.tooltipOptions.followPointer, l = this.getAnchor(r, f), f = l[0], b = l[1], !g || r.series && r.series.noSharedTooltip ? g = r.getLabelConfig() :
                    (E(r, function(a) {
                        ...
                        x: r[0].category,
                        y: r[0].y
                    }, g.points = m, r = r[0]), this.len = m.length, g = e.call(g, this), x = r.series, this.distance = t(x.tooltipOptions.distance, 16), !1 === g ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({
                        opacity: 1
                    }).show(), this.split ? this.renderSplit(g, u(a)) : (c.style.width || e.css({
                        width: this.chart.spacingBox.width
                    }), e.attr({
                        text: g && g.join ? g.join("") : g
                    }), e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + t(r.colorIndex,
                        x.colorIndex)), e.attr({
                        stroke: c.borderColor || r.color || x.color || "#666666"
                    }), this.updatePosition({
                        plotX: f,
                        plotY: b,
                        negative: r.negative,
            ...
            renderSplit: function(g, f) {
                ...
                E(g.slice(0, f.length + 1), function(a, n) {
                    if (!1 !== a) {
                        ...
                        C || (g.tt = C = r.label(null, null, null, "callout", null, null, m.useHTML).addClass("highcharts-tooltip-box " + d).attr({
                            padding: m.padding,
                            r: m.borderRadius,
                            fill: m.backgroundColor,
                            stroke: m.borderColor || n.color || A.color || "#333333",
                        ...
                        a -= b.plotTop;
                        c.push({
                            target: n.isHeader ? b.plotHeight + k : a,
                            rank: n.isHeader ? 1 : 0,
                ...
                E(c, function(a) {
                    ...
                    a.tt.attr({
                        ...
                        x: l || c.isHeader ? a.x : c.plotX + b.plotLeft + t(m.distance, 16),
                        y: a.pos + b.plotTop,
        ...
        a.Pointer.prototype = {
            ...
            runPointActions: function(b, c) {
                var e = this.chart,
                    ...
                    m = this.getHoverData(x, m, e.series, !!c || m && m.directTouch && this.isDirectTouch, g, b, {
                ...
                if (x && (x !== e.hoverPoint || r && r.isHidden)) {
                    ...
                    e.hoverPoint = x;
                    r && r.refresh(g ? n : x, b)
                } else c && r && !r.isHidden && (x = r.getAnchor([{}], b), r.updatePosition({
                    plotX: x[0],
                    plotY: x[1]
                }));
                ...
                w(e.axes, function(c) {
                    var e = f(c.crosshair.snap, !0),
                        l = e ? a.find(n, function(a) {
            ...
            drag: function(a) {
                ...
                p && p.touch || (e < n ? e = n : e > n + k && (e = n + k), f < B ? f = B : f > B + A && (f = B + A), this.hasDragged = Math.sqrt(Math.pow(D - e, 2) + Math.pow(h - f, 2)), 10 < this.hasDragged && (d = b.isInsidePlot(D - n, h - B), b.hasCartesianSeries && (this.zoomX || this.zoomY) && d && !y && !p && (this.selectionMarker = p = b.renderer.rect(n, B, g ? 1 : k, m ? 1 : A, 0).attr({
                    ...
                    height: Math.abs(e),
                    y: (0 < e ? 0 : e) + h
                })), d && !p && c.panning && b.pan(a, c.panning)))
            },
            drop: function(a) {
                var b = this,
                    c = this.chart,
            ...
            onContainerClick: function(a) {
                var b = this.chart,
                    ...
                    f = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (z(c.series, "click", t(a, {
                        point: c
                    })),
    ...
    (function(a) {
        ...
        H(a.Pointer.prototype, {
            pinchTranslate: function(a, k, q, v, m, g) {
            ...
            pinch: function(a) {
                ...
                }), t.res = !0) : t.followTouchMove && 1 === g ? this.runPointActions(t.normalize(a)) : w.length && (c || (t.selectionMarker = c = H({
                    destroy: k,
                    touch: !0
                }, u.plotBox)), t.pinchTranslate(w, m, b, c, l, f), t.hasPinched = e, t.scaleGroups(b, l), t.res && (t.res = !1, this.reset(!1, 0)))
            },
            touch: function(k, t) {
                var u = this.chart,
                    v, m;
            ...
            var m = {},
                ...
                e = function(c, b, e, l) {
                    "touch" !== c.pointerType && c.pointerType !== c.MSPOINTER_TYPE_TOUCH || !E[a.hoverChartIndex] ||
                        (l(c), l = E[a.hoverChartIndex].pointer, l[b]({
                            type: e,
    ...
    (function(a) {
        ...
        a.Legend.prototype = {
            ...
            positionCheckboxes: function() {
                ...
                a && (c = a.translateY, k(this.allItems, function(e) {
                    var l = e.checkbox,
                        g;
                    l && (g = c + f + l.y + (this.scrollOffset || 0) + 3, E(l, {
                        left: a.translateX + e.checkboxOffset + l.x - 20 + "px",
                        top: g + "px",
            ...
            renderItem: function(a) {
                ...
                D || (a.legendGroup = b.g("legend-item").addClass("highcharts-" + y.type + "-series highcharts-color-" + a.colorIndex + (N ? " " + N : "") + (h ? " highcharts-series-" + a.index : "")).attr({
                    zIndex: 1
                }).add(this.scrollGroup), a.legendItem = D = b.text("", q ? f + g : -g, this.baseline || 0, w).css(t(a.visible ? m : k)).attr({
                    align: q ? "left" : "right",
                    zIndex: 2
                ...
                m.width || D.css({
                    width: (e.itemWidth || e.width || c.spacingBox.width) - v
                });
                this.setText(a);
                b = D.getBBox();
            ...
            render: function() {
                ...
                a.offsetWidth = 0;
                a.lastItemY = 0;
                f || (a.group = f = b.g("legend").attr({
                    zIndex: 7
                }).add(), a.contentGroup = b.g().attr({
                    zIndex: 1
                }).add(f), a.scrollGroup = b.g().add(a.contentGroup));
                a.renderTitle();
                l = a.getAllItems();
                m(l, function(a, b) {
                ...
                x += B;
                F || (a.box = F = b.rect().addClass("highcharts-legend-box").attr({
                    r: n.borderRadius
                }).add(f), F.isNew = !0);
                F.attr({
                ...
                0 < q && 0 < x && (F[F.isNew ? "attr" : "animate"](F.crisp.call({}, {
                    x: 0,
                    y: 0,
                    width: q,
                    height: x
                ...
                g && (b = c.spacingBox, /(lth|ct|rth)/.test(a.getAlignment()) && (b = t(b, {
            ...
            handleOverflow: function(a) {
                ...
                a > b && !1 !== n.enabled ? (this.clipHeight = m = Math.max(b - 20 - this.titleHeight - g, 0), this.currentPage = u(this.currentPage, 1), this.fullHeight = a, k(D, function(a, b) {
                    ...
                    c !== p && (p = c)
                }), F || (F = c.clipRect = e.clipRect(0, g, 9999, 0), c.contentGroup.clip(F)), h(m), A || (this.nav = A = e.g().attr({
                        zIndex: 1
                    }).add(this.group),
                    this.up = e.symbol("triangle", 0, 0, q, q).on("click", function() {
                        ...
                        c.scroll(1, B)
                    }).add(A)), c.scroll(0), a = b) : A && (h(), this.nav = A.destroy(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            },
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function(a, c) {
                ...
                c.legendSymbol = this.chart.renderer.rect(e ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, e ? b : a.symbolWidth, b, u(a.options.symbolRadius, b / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(c.legendGroup)
            },
            drawLineMarker: function(a) {
                ...
                b && !1 !== b.enabled && (c = Math.min(u(b.radius, f), f), 0 === this.symbol.indexOf("url") && (b = t(b, {
                    width: l,
                    height: l
                }), c = 0), this.legendSymbol = b = g.symbol(this.symbol, e /
    ...
    (function(a) {
        ...
        e(O.prototype, {
            ...
            redraw: function(d) {
                ...
                this.layOutTitles();
                for (d = h.length; d--;)
                    if (m = h[d], m.options.stacking && (A = !0, m.isDirty)) {
                        g = !0;
                        break
                    }
                if (g)
            ...
            layOutTitles: function(a) {
                ...
                f(["title", "subtitle"], function(a) {
                    ...
                    var n;
                    b && (n = p.style.fontSize, n = c.fontMetrics(n, b).b, b.css({
                            width: (p.width || h.width + p.widthAdjust) + "px"
                        }).align(e({
                            y: a + n
                        }, p), !1, "spacingBox"), p.floating ||
            ...
            setChartSize: function(a) {
                ...
                this.clipBox = {
                    ...
                    height: Math.max(0, Math.floor(this.plotSizeY - Math.max(c, n[2]) / 2 - b))
                };
            ...
            drawChartBox: function() {
                ...
                k ? k.animate({
                    width: F.width,
                    height: F.height
                }) : this.clipRect = d.clipRect(F);
                q = "animate";
                e || (q = "attr", this.plotBorder =
                    e = d.rect().addClass("highcharts-plot-border").attr({
                        zIndex: 1
                    }).add());
                e.attr({
            ...
            renderLabels: function() {
                ...
                b.items && f(b.items, function(c) {
                    ...
                    delete h.left;
                    delete h.top;
                    a.renderer.text(c.html, p, n).attr({
                        zIndex: 2
                    }).css(h).add()
                })
            },
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            insert: function(a) {
                ...
                if (b(d)) {
                    for (c = a.length; c--;)
                        if (d >= I(a[c].options.index, a[c]._i)) {
                            a.splice(c + 1, 0, this);
                            break
                        } - 1 === c && a.unshift(this);
                    c += 1
            ...
            setOptions: function(a) {
                ...
                !d.negativeColor &&
                    !d.negativeFillColor || d.zones || a.push({
            ...
            setData: function(e, d, p, n) {
                ...
                if (!1 !== n && g && f === g && !h.cropped && !h.hasGroupedData && h.visible) z(e, function(a, d) {
                    ...
                    if (B && g > B) {
                        ...
                        for (p = 0; p < g; p++) void 0 !== e[p] && (m = {
                            series: h
                        }, h.pointClass.prototype.applyOptions.apply(m, [e[p]]), h.updateParallelArrays(m, p));
            ...
            setClip: function(a) {
                var d = this.chart,
                    ...
                    f = d[l],
                    g = d[l + "m"];
                f || (a && (n.width = 0, h && (n.x = d.plotSizeX), d[l + "m"] = g = c.clipRect(h ? d.plotSizeX + 99 : -99, h ? -d.plotLeft : -d.plotTop, 99, h ? d.chartWidth : d.chartHeight)), d[l] = f = c.clipRect(n), f.count = {
                    length: 0
                });
            ...
            drawGraph: function() {
                ...
                z(c, function(c, e) {
                    var h = c[0],
                        p = a[h];
                    p ? (p.endX = a.preventGraphAnimation ? null : b.xMap, p.animate({
                        d: b
                    })) : b.length && (a[h] = a.chart.renderer.path(b).addClass(c[1]).attr({
                        zIndex: 1
                    }).add(a.group), p = {
                        stroke: c[2],
                        "stroke-width": d.lineWidth,
                        fill: a.fillGraph && a.color || "none"
                    }, c[3] ? p.dashstyle = c[3] : "square" !== d.linecap && (p["stroke-linecap"] = p["stroke-linejoin"] = "round"), p = a[h].attr(p).shadow(2 > e && d.shadow));
            ...
            applyZones: function() {
                ...
                c.length && (f || g) && r && void 0 !== r.min && (B = r.reversed, q = r.horiz, f && f.hide(), g && g.hide(), x = r.getExtremes(), z(c, function(c, p) {
                    ...
                    r.isXAxis ? (l = {
                        ...
                        width: F,
                        height: m
                    }, q || (l.x = d.plotHeight - l.x)) : (l = {
                        x: 0,
                        y: k ? C : t,
                        width: m,
                        height: F
                    }, q && (l.y = d.plotWidth - l.y));
                    k && b.isVML && (l = r.isXAxis ? {
                        x: 0,
                        y: B ? t : C,
                        height: l.width,
                        width: d.chartWidth
            ...
            plotGroup: function(a, d, b, c, h) {
                var e = this[a],
                    p = !e;
                p && (this[a] = e = this.chart.renderer.g().attr({
                    zIndex: c || .1
                }).add(h));
                ...
                e.attr({
                    visibility: b
                })[p ? "attr" : "animate"](this.getPlotBox());
                return e
            },
            getPlotBox: function() {
                var a = this.chart,
            ...
            redraw: function() {
                ...
                b && (a.inverted && b.attr({
                    ...
                    translateX: I(c && c.left, a.plotLeft),
            ...
            buildKDTree: function() {
                function a(b, c, e) {
                    ...
                    if (p = b && b.length) return h = d.kdAxisArray[c % e], b.sort(function(a, d) {
                        ...
                        point: b[p],
                        left: a(b.slice(0, p), c + 1, e),
                        right: a(b.slice(p + 1), c + 1, e)
                    }
                }
    ...
    (function(a) {
        ...
        a.StackItem = function(a, g, f, e, c) {
            ...
            this.rightCliff = this.leftCliff =
                0;
            this.alignOptions = {
                align: g.align || (b ? f ? "left" : "right" : "center"),
                verticalAlign: g.verticalAlign || (b ? "middle" : f ? "bottom" : "top"),
                y: u(g.y, b ? 4 : f ? 14 : -6),
                x: u(g.x, b ? f ? -6 : 6 : 0)
            };
        ...
        a.StackItem.prototype = {
            ...
            render: function(a) {
                ...
                this.label ? this.label.attr({
                    text: f,
                    visibility: "hidden"
                }) : this.label = this.axis.chart.renderer.text(f, null, null, g.useHTML).css(g.style).attr({
        ...
        G.prototype.renderStackTotals = function() {
            ...
            e || (this.stackTotalGroup = e = g.g("stack-labels").attr({
                visibility: "visible",
                zIndex: 6
            }).add());
    ...
    (function(a) {
        ...
        u(a.Chart.prototype, {
            ...
            showLoading: function(a) {
                ...
                e || (b.loadingDiv = e = v("div", {
                    className: "highcharts-loading highcharts-loading-hidden"
                }, null, b.container), b.loadingSpan = v("span", {
            ...
            update: function(a, e, l) {
                ...
                b(a, function(a, b) {
                    ...
                    else if ("function" === typeof n[d[b]]) n[d[b]](a);
            ...
            getGraphPath: function(a) {
                var q = k.prototype.getGraphPath,
                    ...
                    F = function(n, f, g) {
                        ...
                        void 0 !== p && (c.push({
                            plotX: r,
                            plotY: null === p ? I : m.getThreshold(p),
                            isNull: x,
                            isCliff: !0
                        }), e.push({
                            plotX: r,
                            plotY: null === k ? I : m.getThreshold(k),
                            doCurve: !1
                        }))
                    };
                a = a || this.points;
                ...
                for (g = 0; g < a.length; g++)
                    if (f = a[g].isNull, r = v(a[g].rectPlotX, a[g].plotX), x = v(a[g].yBottom, I), !f || u) u || F(g, g - 1, "left"), f && !w && u || (c.push(a[g]), e.push({
                        x: g,
                        plotX: r,
                        plotY: x
                    })), u || F(g, g + 1, "right");
                ...
                E(z, function(m) {
                    ...
                    f ? (f.endX = a.preventGraphAnimation ?
                        null : q.xMap, f.animate({
                            d: q
                        })) : (f = a[g] = a.chart.renderer.path(q).addClass(m[1]).attr({
                        fill: v(m[3], G(m[2]).setOpacity(v(u.fillOpacity, .75)).get()),
                        zIndex: 0
    ...
    (function(a) {
        ...
        u("column", "line", {
            ...
            getColumnMetrics: function() {
                ...
                a.columnMetrics = {
                    width: g,
                    offset: (x - g) / 2 + (q + ((a.columnIndex || 0) + (c ? 1 : 0)) * x - k / 2) * (c ? -1 : 1)
                };
            ...
            animate: function(a) {
                var g = this,
                    ...
                    l;
                z && (a ? (b.scaleY = .001, a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(e.threshold))), c ? b.translateX = a - f.len : b.translateY = a, g.group.attr(b)) : (l = g.group.attr(r), g.group.animate({
                    scaleY: 1
                }, v(G(g.options.animation), {
                    step: function(a, c) {
                        b[r] = l + c.pos * (f.pos - l);
                        g.group.attr(b)
                    }
        ...
        g("pie", "line", {
            ...
            updateTotals: function() {
                var a, c = 0,
                    b = this.points,
                    f = b.length,
                    l, g = this.options.ignoreHiddenPoint;
            ...
            drawPoints: function() {
                ...
                v(a.points, function(e) {
                    ...
                    if (e.isNull) f && (e.graphic = f.destroy());
                        ...
                        f ? f.setRadialReference(a.center).attr(l).animate(k(g, b)) : (e.graphic = f = c[e.shapeType](g).setRadialReference(a.center).attr(b).add(a.group), e.visible || f.attr({
                            visibility: "hidden"
                        }), f.attr(l).attr({
                            "stroke-linejoin": "round"
                        }).shadow(m, r));
    ...
    (function(a) {
        ...
        g.prototype.drawDataLabels = function() {
            ...
            var b = this,
                ...
                A = b.chart.renderer;
            if (f.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(f), B = b.plotGroup("dataLabelsGroup", "data-labels", u && !m ? "hidden" : "visible", f.zIndex || 6), u && (B.attr({
                opacity: +m
            }), m || G(b, "afterAnimate", function() {
                b.visible && B.show(!0);
                ...
                p && (f = t(x, k), h = d.getLabelConfig(), F = f[d.formatPrefix + "Format"] || f.format, n = H(F) ? q(F, h) : (f[d.formatPrefix + "Formatter"] || f.formatter).call(h, f), F = f.style, h = f.rotation, F.color = z(f.color, F.color, b.color, "#000000"), "contrast" === F.color && (d.contrastColor = A.getContrast(d.color || b.color), F.color = f.inside || 0 > z(d.labelDistance,
                    f.distance) || e.stacking ? d.contrastColor : "#000000"), e.cursor && (F.cursor = e.cursor), g = {
                    fill: f.backgroundColor,
        ...
        g.prototype.alignDataLabel = function(a, b, e, f, g) {
            var c = this.chart,
                ...
                D = "justify" === z(e.overflow,
                    "justify");
            if (p && (q = e.style.fontSize, q = c.renderer.fontMetrics(q, b).b, f = k({
                        x: l ? this.yAxis.len - n : r,
                        y: Math.round(l ? this.xAxis.len - r : n),
                        width: 0,
                        height: 0
                    }, f), k(e, {
                        width: m.width,
                        height: m.height
                    }), t ? (D = !1, r = c.renderer.rotCorr(q, t), r = {
                        x: f.x + e.x + f.width / 2 + r.x,
                        y: f.y + e.y + {
                            top: 0,
                            middle: .5,
                            bottom: 1
                        }[e.verticalAlign] * f.height
                    }, b[g ? "attr" : "animate"](r).attr({
                        align: d
                    }), n = (t + 720) % 360, n = 180 < n && 360 > n, "left" === d ? r.y -= n ? m.height : 0 : "center" === d ? (r.x -= m.width / 2, r.y -= m.height / 2) : "right" === d && (r.x -= m.width, r.y -= n ? 0 : m.height)) :
                    (b.align(e, null, f), r = b.alignAttr), D ? a.isLabelJustified = this.justifyDataLabel(b, e, r, m, f, g) : z(e.crop, !0) && (p = c.isInsidePlot(r.x, r.y) && c.isInsidePlot(r.x + m.width, r.y + m.height)), e.shape && !t)) b[g ? "attr" : "animate"]({
            ...
            c.visible && (k.enabled || c._hasPointLabels) && (v(b, function(a) {
                ...
                if (x)
                    for (c.sortByAngle(b, l - .5), 0 < c.maxLabelDistance && (g = Math.max(0, d - A - c.maxLabelDistance), r = Math.min(d +
                            ...
                            0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, d - A - a.labelDistance), a.bottom = Math.min(d + A + a.labelDistance, f.plotHeight), B = a.dataLabel.getBBox().height || 21, a.positionsIndex = t.push({
                        ...
                        M = k.justify ? u[0] + (l ? -1 : 1) * (A + e.labelDistance) : c.getX(O < e.top + 2 || O > e.bottom - 2 ? g : O, l, e), p._attr = {
                            visibility: N,
                            align: h[6]
                        }, p._pos = {
                            x: M + k.x + ({
                            ...
                            y: O + k.y - 10
                        }, h.x = M, h.y = O, z(k.crop, !0) && (D = p.getBBox().width, g = null, M - D < m ? (g = Math.round(D - M + m), K[3] = Math.max(g, K[3])) : M + D > q - m && (g = Math.round(M + D - q + m), K[1] = Math.max(g, K[1])), 0 > O - y / 2 ? K[0] = Math.max(Math.round(-O + y / 2), K[0]) : O + y / 2 > n && (K[2] = Math.max(Math.round(O + y / 2 - n), K[2])), p.sideOverflow = g)
                ...
                x && v(this.points, function(a) {
                    ...
                    if ((p = a.dataLabel) && p._pos && a.visible && 0 < a.labelDistance) {
                        ...
                        if (d = !t) a.connector = t = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(c.dataLabelsGroup), t.attr({
                            "stroke-width": x,
        ...
        f.column && (f.column.prototype.alignDataLabel = function(a, b, e, f, k) {
            ...
            r && (f = t(r), 0 > f.y && (f.height += f.y, f.y = 0), r = f.y + f.height - l.yAxis.len, 0 < r && (f.height -= r), c && (f = {
                x: l.yAxis.len - f.y - f.height,
                y: l.xAxis.len - f.x - f.width,
                width: f.height,
                height: f.width
            }), m || (c ? (f.x += n ? 0 : f.width, f.width = 0) : (f.y +=
        ...
        a(G.prototype, "render", function() {
            ...
            E(this.yAxis || [], function(k) {
                k.options.stackLabels &&
                    !k.options.stackLabels.allowOverlap && H(k.stacks, function(k) {
                        H(k, function(k) {
                            a.push(k.label)
                        })
                    })
    ...
    (function(a) {
        ...
        I = a.TrackerMixin = {
            drawTrackerPoint: function() {
                ...
                a._hasTracking || (w(a.trackerGroups, function(e) {
                    if (a[e]) {
                        ...
                        a.options.cursor && a[e].css(v).css({
            ...
            drawTrackerGraph: function() {
                ...
                h ? h.attr({
                    d: e
                }) : a.graph && (a.tracker = p.path(e).attr({
                    "stroke-linejoin": "round",
        ...
        t(E.prototype, {
            ...
            pan: function(a, b) {
                ...
                w("xy" === b ? [1, 0] : [1], function(b) {
                    ...
                    m = l - h;
                    0 < m && (l = h, g -= m);
                    b.series.length && g !== n.min && l !== n.max && (b.setExtremes(g, l, !1, !1, {
                        trigger: "pan"
                    }), f = !0);
                    c[d] =
                        e
        ...
        t(b.prototype, {
            ...
            setState: function(a, b) {
                ...
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === l.enabled || a && (h || p && !1 === k.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" +
                    ...
                    }(e = l.halo) && e.size ? (u || (g.halo = u = x.renderer.path().add((this.graphic || m).parentGroup)), u[b ? "animate" : "attr"]({
                        ...
                        zIndex: -1
                    }, e.attributes))) : u && u.point && u.point.haloPath && u.animate({
        ...
        t(r.prototype, {
            ...
            setState: function(a) {
                ...
                if (b.state !== a && (w([b.group, b.markerGroup, b.dataLabelsGroup], function(d) {
                    ...
                    }), b.state = a, !g[a] || !1 !== g[a].enabled) && (a && (l = g[a].lineWidth || l + (g[a].lineWidthPlus || 0)), f && !f.dashstyle))
                    for (l = {
                            "stroke-width": l
                        }, f.animate(l, c(b.chart.options.chart.animation, g[a] && g[a].animation)); b["zone-graph-" + e];) b["zone-graph-" + e].attr(l), e += 1
            },
    ...
    (function(a) {
        ...
        G.prototype.setResponsive = function(k) {
            ...
            var g = a.merge.apply(0, a.map(t, function(f) {
                ...
                t = t.toString() || void 0;
            t !== (m && m.ruleIds) && (m && this.update(m.undoOptions, k), t ? (this.currentResponsive = {
                ruleIds: t,
                mergedOptions: g,
                undoOptions: this.currentOptions(g)
            }, this.update(g, k)) : this.currentResponsive = void 0)
        };
        ...
        t(E.prototype, {
            ...
            lin2val: function(a, e) {
                ...
                if (c) {
                    var b = this.ordinalSlope,
                        ...
                        g = c.length - 1,
                        k;
                    if (e) 0 > a ? a = c[0] : a > g ? a = c[g] : (g = Math.floor(a), k = a - g);
                    else
                        for (; g--;)
                            if (e = b * g + f, a >= e) {
                                b = b * (g + 1) + f;
            ...
            getOverscrollPositions: function() {
                var f = this.options.overscroll,
                    ...
                    b = this.dataMax;
                if (a.defined(e))
                    for (c.push(b); b <= this.dataMax + f;) b += e, c.push(b);
                return c
            },
        ...
        g(H.prototype, "pan", function(a, e) {
            ...
            if (c.options.ordinal && c.series.length) {
                ...
                A.ordinalPositions ? 1 < Math.abs(k) && (u && w(u, function(a) {
                        a.setState()
                    }), 0 > k ? (u = A, p = c.ordinalPositions ? c : A) : (u = c.ordinalPositions ? c : A, p = A), A = p.ordinalPositions, q > A[A.length - 1] && A.push(q), this.fixedRange = n - t, k = c.toFixedRange(null, null, z.apply(u, [d.apply(u, [t, !0]) + k, !0]), z.apply(p, [d.apply(p, [n, !0]) + k, !0])), k.min >= Math.min(m.dataMin, t) && k.max <= Math.max(q, n) + b && c.setExtremes(k.min, k.max, !0, !1, {
                        trigger: "pan"
                    }), this.mouseDownX =
                    f, v(this.container, {
                        cursor: "move"
    ...
    (function(a) {
            ...
            e.isBroken && (e.val2lin = function(a) {
                ...
                k(b, function(a) {
                    ...
                    0 === g && (c.push({
                        from: B,
                        to: a.value,
                        len: a.value - B - (a.size || 0)
                    }), f += a.value - B - (a.size || 0))
                });
                e.breakArray = c;
        ...
        a.Series.prototype.drawBreaks = function(a, g) {
            ...
            a && k(g, function(g) {
                ...
                k(e, function(e) {
                    ...
                    k(c, function(c) {
                        m = !1;
                        if (b < c.from && l > c.to || b > c.from && l < c.from) m = "pointBreak";
        ...
        a.Series.prototype.gappedPath = function() {
            var k = this.options.gapSize,
                ...
                c;
            if (k && 0 < f)
                for ("value" !== this.options.gapUnit && (k *= this.closestPointRange); f--;) g[f + 1].x - g[f].x > k && (c = (g[f].x + g[f + 1].x) / 2, g.splice(f + 1, 0, {
                    isNull: !0,
                    x: c
                }), this.options.stacking && (c = e.stacks[this.stackKey][c] = new a.StackItem(e, e.options.stackLabels, !1, c, this.stack), c.total = 0));
    ...
    (function(a) {
        ...
        c.groupData = function(a, b, c, e) {
            ...
            for (J; J <= k; J++) {
                ...
                if (B) {
                    m = this.cropStart + J;
                    var E = f && f[m] || this.pointClass.prototype.applyOptions.apply({
                            series: this
                        }, [d[m]]),
                        I;
        ...
        e(f.prototype, "tooltipFooterHeaderFormatter", function(b, c, e) {
            var f = c.series,
                ...
                l, h = f.xAxis,
                n = a.dateFormat;
            return h && "datetime" === h.options.type && d && u(c.key) ? (b = f.currentDataGrouping, d = d.dateTimeLabelFormats, b ? (h = d[b.unitName], 1 === b.count ? p = h[0] : (p = h[1], l = h[2])) : !p && d && (p = this.getXDateFormat(c, g, h)), p = n(p, c.key), l && (p += n(l, c.key + b.totalRange - 1)), t(g[(e ? "footer" : "header") + "Format"], {
                point: w(c.point, {
                    key: p
                }),
                series: f
        ...
        H.prototype.setDataGrouping = function(a, b) {
            ...
            else q(this.chart.options.series, function(b) {
                b.dataGrouping = a
            }, !1);
            b && this.chart.redraw()
        }
            ...
            drawPoints: function() {
                ...
                G(a.points, function(k) {
                    ...
                    void 0 !== k.plotY && (g || (k.graphic = g = q.renderer.path().add(a.group)), g.attr(a.pointAttribs(k, k.selected && "select")), u = g.strokeWidth() % 2 / 2, f = Math.round(k.plotX) - u, v = Math.round(k.shapeArgs.width / 2), m = ["M", f, Math.round(k.yBottom), "L", f, Math.round(k.plotHigh)], null !== k.open && (t = Math.round(k.plotOpen) + u, m.push("M", f, t, "L", f - v, t)),
                        null !== k.close && (t = Math.round(k.plotClose) + u, m.push("M", f, t, "L", f + v, t)), g[e ? "attr" : "animate"]({
                            d: m
    ...
    (function(a) {
        ...
        v("candlestick", "ohlc", H(G.column, {
            ...
            pointAttribs: function(a, v) {
                var q = k.column.prototype.pointAttribs.call(this, a, v),
                    u = this.options,
                    w = a.open < a.close,
                ...
                E(a.points,
                    function(q) {
                        ...
                        void 0 !== q.plotY && (t || (q.graphic = t = k.renderer.path().add(a.group)), t.attr(a.pointAttribs(q, q.selected && "select")).shadow(a.options.shadow), e = t.strokeWidth() % 2 / 2, c = Math.round(q.plotX) - e, v = q.plotOpen, m = q.plotClose, g = Math.min(v, m), v = Math.max(v, m), b = Math.round(q.shapeArgs.width / 2), m = Math.round(g) !== Math.round(q.plotHigh), f = v !== q.yBottom, g = Math.round(g) + e, v = Math.round(v) + e, e = [], e.push("M", c - b, v, "L", c - b, g, "L", c + b, g, "L", c + b, v, "Z", "M", c, g, "L", c, m ? Math.round(q.plotHigh) :
                            g, "M", c, v, "L", c, f ? Math.round(q.yBottom) : v), t[r ? "attr" : "animate"]({
                            d: e
        ...
        t("flags", "column", {
            ...
            drawPoints: function() {
                ...
                for (t = g.length; t--;) u = g[t], B = u.plotX > this.xAxis.len, c = u.plotX, w = u.stackIndex, q = u.options.shape || m.shape, b = u.plotY, void 0 !== b && (b = u.plotY + l - (void 0 !== w &&
                    w * m.stackDistance)), u.anchorX = w ? void 0 : u.plotX, n = w ? void 0 : u.plotY, w = u.graphic, void 0 !== b && 0 <= c && !B ? (w || (w = u.graphic = e.label("", null, null, q, null, null, m.useHTML).attr(this.pointAttribs(u)).css(k(m.style, u.style)).attr({
                    align: "flag" === q ? "left" : "center",
                    width: m.width,
                    height: m.height,
                    "text-align": m.textAlign
                }).addClass("highcharts-point").add(this.markerGroup), u.graphic.div && (u.graphic.div.point = u), w.shadow(m.shadow), w.isNew = !0), 0 < c && (c -= w.strokeWidth() % 2), q = {
                    y: b,
                    anchorY: n
                }, m.allowOverlapX && (q.x = c, q.anchorX =
                    u.anchorX), w.attr({
                    text: u.options.title || m.title || "A"
                })[w.isNew ? "attr" : "animate"](q), m.allowOverlapX || (A[u.plotX] ? A[u.plotX].size = Math.max(A[u.plotX].size, w.width) : A[u.plotX] = {
                    align: 0,
                    size: w.width,
                    target: c,
                    anchorX: c
                }), u.tooltipPos = f.inverted ? [z.len + z.pos - f.plotLeft - b, this.xAxis.len - c] : [c, b + z.pos - f.plotTop]) : w && (u.graphic = w.destroy());
    ...
    (function(a) {
        ...
        G.prototype = {
            ...
            setRange: function(a, b) {
                ...
                q(g) && (a = Math.max(a, 0), l = Math.ceil(g * a), this.calculatedWidth = k = v(g * Math.min(b, 1) - l), k < f && (l = (g - f + k) * a, k = f), f = Math.floor(l + this.xOffset + this.yOffset), g = k / 2 - .5, this.from = a, this.to = b, e ? (this.scrollbarGroup[m]({
                        translateY: f
                    }), this.scrollbar[m]({
                        height: k
                    ...
                    0) : (this.scrollbarGroup[m]({
                    translateX: f
                }), this.scrollbar[m]({
                    width: k
                }), this.scrollbarRifles[m]({
                    translateX: g
                }), this.scrollbarLeft = f, this.scrollbarTop = 0), 12 >= k ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === c.showFull && (0 >= a && 1 <= b ? this.group.hide() : this.group.show()), this.rendered = !0)
            },
            initEvents: function() {
                var a = this;
        ...
        G.prototype = {
            ...
            renderElements: function() {
                var a = this,
                    ...
                    g = e.renderer,
                    n;
                a.navigatorGroup = n = g.g("navigator").attr({
                    zIndex: 8,
                    visibility: "hidden"
                }).add();
                var k = {
                ...
                b.handles.enabled && u([0, 1], function(d) {
                    ...
                    a.handles[d].attr({
                        zIndex: 7 - d
                    }).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][d]).add(n);
                    var c = b.handles;
                    a.handles[d].attr({
            ...
            render: function(d, c, e, h) {
                ...
                if (!this.hasDragged || w(e)) {
                    ...
                    m && (this.navigatorGroup.attr({
                        visibility: "visible"
                    }), r = r && !this.hasDragged ? "animate" : "attr", this.drawMasks(e, q, p, r), this.drawOutline(e, q, p, r), this.navigatorOptions.handles.enabled && (this.drawHandle(e,
            ...
            shadesMousedown: function(a,
                ...
                1 === b ? (this.grabbedCenter = n, this.fixedWidth = p, this.dragOffset = n - e) : (a = n - f - p / 2, 0 === b ? a = Math.max(0, a) : 2 === b && a + p >= g && (a = g - p, k = this.getUnionExtremes().dataMax), a !== e && (this.fixedWidth = p, b = c.toFixedRange(a, a + p, null, k), w(b.min) && d.xAxis[0].setExtremes(Math.min(b.min, b.max), Math.max(b.min, b.max), !0, null, {
                    trigger: "navigator"
                })))
            },
            ...
            init: function(a) {
                ...
                a.isDirtyBox = !0;
                n.navigatorEnabled ? (n.xAxis = new H(a, l({
                    ...
                    l(d.yAxis, {
                        ...
                        height: b
                    })), e || d.series.data ? n.updateNavigatorSeries() : 0 === a.series.length && B(a, "redraw", function(b, d) {
                    ...
                    translate: function(b, d) {
                        var c = a.xAxis[0],
                            ...
                            c = A("max", c.options.max, e.dataMax) - h;
                ...
                a.options.scrollbar.enabled && (a.scrollbar = n.scrollbar = new x(a.renderer, l(a.options.scrollbar, {
                    margin: n.navigatorEnabled ? 0 : 10,
                    vertical: a.inverted
                }), a), E(n.scrollbar, "changed", function(b) {
                    var d = n.size,
                        c = d * this.to,
                        d = d * this.from;
            ...
            getUnionExtremes: function(a) {
                var b = this.chart.xAxis[0],
                    ...
                    f;
                a && null === b.dataMin || (f = {
                    dataMin: C(c && c.min, A("min", e.min, b.dataMin, d.dataMin, d.min)),
                    dataMax: C(c && c.max, A("max", e.max, b.dataMax, d.dataMax, d.max))
                });
                return f
            },
    ...
    (function(a) {
        ...
        G.prototype = {
            clickButton: function(a, b) {
                ...
                if (null !== h && null !== k) {
                    e.fixedRange = n;
                    z && (this.forcedDataGrouping = !0, H.prototype.setDataGrouping.call(g || {
                        chart: this.chart
                    }, z, !1));
                    if ("month" === q || "year" === q) g ? (q = {
                        ...
                        if (g) void 0 === k && (h = Number.MAX_VALUE, k = Number.MIN_VALUE, f(e.series, function(a) {
                            a = a.xData;
                            h = Math.min(a[0], h);
                            k = Math.max(a[a.length - 1], k)
                        }), b = !1), m = c.getYTDExtremes(k, h, u), l = v = m.min, m = m.max;
                        else {
                    ...
                    }) : (t = x(e.options.xAxis)[0], B = t.range, t.range = n, w = t.min, t.min = v, E(e, "load", function() {
                        t.range = B;
                        t.min = w
                    }))
                }
            ...
            updateButtonStates: function() {
                ...
                f(this.buttonOptions, function(a, f) {
                    ...
                    var y = n > g - d,
                        ...
                        x = !1,
                        n = n === c;
                    ("month" === p || "year" === p) && c + 36E5 >= 864E5 * {
                        month: 28,
                        year: 365
                    }[p] * r + a && c - 36E5 <= 864E5 * {
                        month: 31,
                        year: 366
                    }[p] * r + a ? n = !0 : "ytd" === p ? (n = h - k + a === c, w = !f) : "all" === p && (n = b.max - b.min >= g - d, x = !f && m && n);
                    p = !q && (y || A || x || e);
                    r = f && n || n && !m && !w;
                    p ? v = 3 : r && (m = !0, v = 2);
            ...
            setInputValue: function(a, b) {
                ...
                this[a + "DateBox"].attr({
                    text: w(c.inputDateFormat || "%b %e, %Y", e.HCTime)
                })
            },
            ...
            drawInput: function(a) {
                function b() {
                    ...
                    b !== v.previousValue && (v.previousValue = b, r(b) || (b = a.split("-"), b = Date.UTC(I(b[0]), I(b[1]) - 1, I(b[2]))), r(b) && (u || (b += 6E4 * (new Date).getTimezoneOffset()), m ? b > c.maxInput.HCTime ?
                        b = void 0 : b < g && (b = g) : b < c.minInput.HCTime ? b = void 0 : b > e && (b = e), void 0 !== b && d.setExtremes(m ? b : d.min, m ? d.max : b, void 0, void 0, {
                ...
                this[a + "Label"] = w = g.label(t.lang[m ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).addClass("highcharts-range-label").attr({
                    padding: 2
                }).add(x);
                x.offset += w.width + 5;
            ...
            render: function(a, b) {
                ...
                if (!1 !== m.enabled) {
                    G ||
                        (c.group = G = d.g("range-selector-group").attr({
                            zIndex: 7
                        }).add(), c.buttonGroup = F = d.g("range-selector-buttons").add(G), c.zoomText = d.text(n.rangeSelectorZoom, C(B + v.x, B), 15).css(m.labelStyle).add(F), E = C(B + v.x, B) + c.zoomText.getBBox().width + 5, f(c.buttonOptions, function(a, b) {
                            r[b] = d.button(a.text, E, 0, function() {
                                ...
                                !1 !== e && c.clickButton(b);
                                c.isActive = !0
                            }, u, z && z.hover, z && z.select, z && z.disabled).attr({
                                "text-align": "center"
                            }).add(F);
                            E += r[b].width + C(m.buttonSpacing,
                                5)
                        }), !1 !== x && (c.div = l = q("div", null, {
                            position: "relative",
                            height: 0,
                            zIndex: 1
                        }), g.parentNode.insertBefore(l, g), c.inputGroup = l = d.g("input-group").add(G), l.offset = 0, c.drawInput("min"), c.drawInput("max")));
                    ...
                    !1 !== x && (T = h && this.titleCollision(e) && "top" === H && "right" === w.align && w.y - l.getBBox().height - 12 < (h.y || 0) + h.height + e.spacing[0] ? -40 : 0, "left" === w.align ? V = B : "right" === w.align && (V = -Math.max(e.axisOffset[1], -T)), l.align({
                        y: w.y,
                        width: l.getBBox().width,
                        align: w.align,
                        x: w.x + V - 2
                    }, !0, e.spacingBox), g = l.alignAttr.translateX + l.alignOptions.x - T + l.getBBox().x + 2, h = l.alignOptions.width, n = F.alignAttr.translateX + F.getBBox().x, V = F.getBBox().width + 20, (w.align === v.align || n + V > g && g + h >
                        n && Y < X + l.getBBox().height) && l.attr({
                        translateX: l.alignAttr.translateX + (e.axisOffset[1] >= -T ? 0 : -T),
                        translateY: l.alignAttr.translateY + F.getBBox().height + 10
        ...
        H.prototype.toFixedRange = function(a, b, c, e) {
            ...
            c = d && (b - a) / d;.7 < c && 1.3 > c && (e ? a = b - d : b = a + d);
            r(a) && r(b) || (a = b = void 0);
            return {
                min: a,
                max: b
    ...
    (function(a) {
        ...
        a.StockChart = a.stockChart = function(b, k, l) {
            ...
            m = e({
                ...
                scrollbar: {
                    enabled: c(n.scrollbar.enabled, !0)
                },
                rangeSelector: {
                    enabled: c(n.rangeSelector.enabled, !0)
                },
                title: {
                    text: null
                },
        ...
        F(H.prototype, "drawCrosshair", function(a, b, e) {
            ...
            if (k(this.crosshair.label) && this.crosshair.label.enabled && this.cross) {
                ...
                n.attr({
                    ...
                    anchorY: l ? this.opposite ? a.chartHeight : 0 : m + b.height / 2
                })
            }
        });
        n.init = function() {
        ...
        n.processData = function() {
            ...
            if (this.xAxis && this.processedYData)
                for (c =
                    ...
                    if (k = e[a] && -1 < b ? e[a][b] : e[a], m(k) && c[a + f] >= this.xAxis.min && 0 !== k) {
                        this.compareValue = k;
                        break
                    }
        };
